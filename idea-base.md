...
5. **Forma del camino:** el GDD no define su trazado exacto, solo que es "fijo". Se diseñó un serpenteo de 6 columnas × 10 filas (5 pasadas horizontales) — ver sección "Pendientes" para el ajuste de 14→10 filas hecho tras un bug real reportado por el usuario (bottom bar tapando la base).
...
- Tablero: grilla 6×10, camino serpenteante fijo, cámara con paneo vertical (drag, hoy no-op — ver "Pendientes"), tap para construir/seleccionar.
